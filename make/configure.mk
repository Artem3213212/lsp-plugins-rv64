...
MERGED_DEPENDENCIES        := \
  ...
  $(PLUGIN_DEPENDENCIES) \
  $(PLUGIN_SHARED)
BLACKLISTED_DEPENDENCIES := LIBJACK LIBGL LIBGSTREAMER_AUDIO LIBXRANDR LIBX11 LIBCAIRO
UNIQ_MERGED_DEPENDENCIES   := $(call uniq, $(filter-out $(BLACKLISTED_DEPENDENCIES), $(MERGED_DEPENDENCIES)))
